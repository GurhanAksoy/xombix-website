// XombiX Whitepaper – July 2025 (Full JSX Component)
...
export default function Whitepaper() {
  return (
    <main className="relative min-h-screen text-gray-100 px-4 sm:px-6 py-12 max-w-4xl mx-auto font-sans leading-relaxed z-10">
      ...
      {/* Sections will be rendered below */}
      {/* 1. Introduction */}
      ...
      <section className="mb-12">
        ...
        <p className="text-sm text-gray-400 italic mb-4">* Going to Mars takes more than dreams. Colonies need culture and funding. That’s why XombiX created the Mars Survival Support Fund. DAO-managed. Meme-powered.</p>
        <div className="overflow-x-auto">
          <table className="min-w-full border border-gray-700 text-sm md:text-base">
            ...
            <tbody className="bg-gray-900 text-gray-100">
              <tr><td className="py-2 px-4 border border-gray-700">Presale</td><td className="py-2 px-4 border border-gray-700">5%</td><td className="py-2 px-4 border border-gray-700">38,850,000</td><td className="py-2 px-4 border border-gray-700">500 people × 77,700<br />Presale Price: $0.00077</td></tr>
              <tr><td className="py-2 px-4 border border-gray-700">Developer (Locked)</td><td className="py-2 px-4 border border-gray-700">15%</td><td className="py-2 px-4 border border-gray-700">116,550,000</td><td className="py-2 px-4 border border-gray-700">Locked for 7 months, then linearly vested monthly</td></tr>
      ...
      <section className="mb-12">
        ...
        <p className="text-orange-200 italic mb-6">XombiX is not a coin you hold. It’s a tool you wield.</p>
        ...
        <ul className="list-disc list-inside text-gray-100 mt-4 space-y-2">
          <li>
            <strong>🗳 MemeDAO Voting</strong><br />
            Cast your vote on proposals that shape the future — from treasury allocations to meme campaigns, shrine designs to burn events. One token, one voice.
          </li>
          <li>
            <strong>🎨 Meme-to-Earn Participation</strong><br />
            Earn XombiX by creating viral content. The more impact your meme has, the more you earn. Humor = capital.
          </li>
          <li>
            <strong>🔓 Exclusive NFT Drops</strong><br />
            Access NFT “Shrines” — cultural relics of the memeverse — available only to XombiX holders.
          </li>
          <li>
            <strong>⚔️ Meme Battle Arenas</strong><br />
            Enter creative combat. Token holders can compete in community meme tournaments judged by the DAO.
          </li>
          <li>
            <strong>🛡 Cultural Identity</strong><br />
            Holding XombiX is a signal — a membership card in a decentralized resistance. It’s your cultural proof-of-work.
          </li>
          <li>
            <strong>📢 Special Events & Calls</strong><br />
            Participate in token-gated events, community AMAs, and secret missions. Only for those who dare.
          </li>
        </ul>
      ...
      <section className="mb-12">
        ...
        <p className="text-base text-gray-200">
          <strong>Presale Size:</strong> 500 participants × 77,700 XOMBIX = 38,850,000 XOMBIX (5% of total supply)
        </p>
        <p className="text-base text-gray-200 mt-2">
          <strong>Presale Price:</strong> $0.00077 per token
        </p>
        <p className="text-base text-gray-200 mt-4">
          <strong>Launch Price Target:</strong> $0.0077 (10× return for early believers)
        </p>
        ...
        <p className="text-base text-gray-200 mt-4">
          All presale participants are subject to the same vesting timeline. The developer’s allocation will follow an identical lockup and release structure for full alignment.
        </p>
      </section>

            {/* 6. DAO & Treasury Governance */}
      <section className="mb-12">
        <h2 className="text-2xl text-orange-300 font-bold mb-4">6. DAO & Treasury Governance</h2>
        <p className="text-orange-200 italic mb-6">You don’t follow XombiX. You become it.</p>
      ...
      <section className="mb-12">
        <h2 className="text-2xl text-orange-300 font-bold mb-4">7. Blockchain & Smart Contract</h2>
        <p className="text-orange-200 italic mb-6">Yes, we exist. Not in imagination — but on-chain.</p>

        <p className="text-base text-gray-200">
          XombiX is currently deployed on the Sepolia testnet — our cosmic sandbox for iterating code, simulating chaos, and hardening trust.
        </p>

        <p className="text-base text-gray-200 mt-4">
          The mainnet launch is set for <strong>[Base / Ethereum / TBD]</strong>, using a battle-tested ERC-20 architecture (yes, we still believe in standards).
        </p>
        ...
        <p className="text-base text-gray-200 mt-4">
          As of now, the entire token supply is held by the deployer for simulation purposes. No distribution has occurred on the testnet, and no liquidity or transfers are enabled. This structure ensures secure testing and prevents misuse prior to mainnet launch.
        </p>
        ...
        <p className="text-base text-gray-200 mt-4">
          Source code will be fully open on Etherscan and GitHub — because transparency isn't a feature, it's a weapon.
        </p>

        <p className="text-orange-200 italic mt-6">
          Want to build with us? Or just watch from orbit?<br />
          Either way, you're invited. This isn’t just a chain. It’s the signal.
        </p>
      </section>

            {/* 8. Risk & Disclaimer */}
      <section className="mb-12">
        <h2 className="text-2xl text-orange-300 font-bold mb-4">8. Risk & Disclaimer</h2>

        <p className="text-base text-gray-200">
          This is not financial advice. XombiX is not a get-rich-quick scheme. It’s not backed by venture capital,
          celebrity endorsements, or promises of eternal green candles.
        </p>

        <p className="text-base text-gray-200 mt-4">
          We are not your gurus. We are not your exit strategy. We are not promising the moon — because we understand how gravity works.
        </p>

        <p className="text-base text-gray-200 mt-4">
          Holding XOMBIX involves risk. The protocol is experimental. The community is unpredictable. The market is irrational.
          Smart contracts may contain bugs. MemeDAO decisions may fail — or succeed beyond reason.
          Liquidity can evaporate overnight. Your tokens could become worthless — or worth everything — depending on how the story unfolds.
        </p>

        <p className="text-base text-gray-200 mt-4">
          XombiX is a cultural artifact wrapped in code, not a guaranteed outcome.
          If you’re here, you’re part of a movement, not a transaction.
        </p>

        <p className="text-base text-gray-200 mt-4">
          Do your own research.<br />
          Take your own responsibility.<br />
          And above all — laugh wisely.
        </p>
