...
export default function Home() {
  return (
    <main className="relative min-h-screen bg-[url('/background-stars.webp')] bg-cover bg-no-repeat bg-center text-white text-center px-4 sm:px-6 pt-6 pb-2 font-sans overflow-hidden z-10 flex flex-col items-center justify-center">
  ...
  <p className="italic text-base text-gray-400 mb-4 relative z-20">
