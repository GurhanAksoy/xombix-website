...
/>
        ...
        <div>
         <a href="#presale"
  className="inline-block bg-white text-black px-6 py-3 rounded-2xl text-lg transition duration-300 transform hover:scale-105 hover:shadow-xl hover:bg-gradient-to-r hover:from-purple-400 hover:to-blue-500"
>
  👾 Ön Satışa Katıl
</a>
